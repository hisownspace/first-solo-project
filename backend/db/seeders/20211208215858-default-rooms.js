...
module.exports = {
  up: (queryInterface, Sequelize) => {
   ...
   return queryInterface.bulkInsert('Rooms', [
     ...
     {createdAt: new Date(), updatedAt: new Date(), ownerId: 3, title: 'Rich Jerk', description: 'You cannot stay here. We just wanted to brag about our awesome house', address: '344 Bigot Ln', city: 'Hamlet', state: 'Wyoming', zip: '12345', amenities: 'pool, full kitchen, microwave, private bathroom', country: 'USA', imageUrl: 'https://a0.muscache.com/im/pictures/a28a6ed5-7f45-48d4-be08-90519655037c.jpg?im_w=960'},
